...
class Flight(Entity):
    ...
    def set_flight_details(self, flight_details: Dict) -> None:
        ...
        dest_airport_region = self.__get_info(dest_airport_position.get("region"), dict())
        ...
        orig_airport_region = self.__get_info(orig_airport_position.get("region"), dict())
        ...
        self.destination_airport_country_region_city = self.__get_info(dest_airport_region.get("city"))
        ...
        self.origin_airport_country_region_city = self.__get_info(orig_airport_region.get("city"))
